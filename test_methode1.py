...
def main():
    ...
    sol,sol_pl,temps,nb_question,erreur,list_mmr_en_iteration=test_m1.une_experience_sp()
    print("solution methode1 : ",sol)
    print("solution PL : " ,sol_pl)
    print("temps de calcul : " , temps)
    print("nombre de questions posées : " ,nb_question)
    print("variation de mmr pour chaque itération(en fonction de questions posées) ",list_mmr_en_iteration )
    print("erreur par rapport à la solution optimale du décideur : ", erreur)
    print("\n---------------- test methode1 owa --------------------------- ")
    print(" w* pour owa" ,test_m1.poids_OWA)
    sol2,sol_pl2,temps2,nb_question2,erreur2,list_mmr_en_iteration2=test_m1.une_experience_owa()
    print("solution methode1 : ",sol2)
    print("solution PL : " ,sol_pl2)
    print("temps de calcul : " , temps2)
    print("nombre de questions posées : " ,nb_question2)
    print("variation de mmr pour chaque itération(en fonction de questions posées) ",list_mmr_en_iteration2 )
